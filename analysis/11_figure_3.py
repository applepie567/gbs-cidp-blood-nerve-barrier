...
d = d.loc[['SELE','IL2RA','THBD','CR2','CD38','CCL3','CD1C','NRP1']]
...
y = np.arange(len(d))
for name,offset,col,marker,label in [('discovery',.13,BLUE,'o','Discovery'),('replication',-.13,ORANGE,'s','Independent replication')]:
