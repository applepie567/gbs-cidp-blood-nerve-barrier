...
The earlier analysis_update folder retains the version 39 CSF correction and earlier figure code. Its cross compartment evidence table has been updated to include the version 41 Fc caveat. This package is archived as release v2.2.0 at https://doi.org/10.5281/zenodo.22636223. The preceding v2.1.0 records do not contain these new files.
